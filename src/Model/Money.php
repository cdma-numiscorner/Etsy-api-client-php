...
class Money implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['divisor'] = $data['divisor'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['divisor'] === null) {
            $invalidProperties[] = "'divisor' can't be null";
        }
        if (($this->container['divisor'] < 0)) {
            $invalidProperties[] = "invalid value for 'divisor', must be bigger than or equal to 0.";
        }
     ...
     * Sets amount
     *
     * @param int $amount The amount of represented by this data.
     *
     * @return self
     */
     ...
     * Sets divisor
     *
     * @param int $divisor The divisor to render the amount.
     *
     * @return self
     */
    public function setDivisor($divisor)
    {
        ...
        if (($divisor < 0)) {
            throw new \InvalidArgumentException('invalid value for $divisor when calling Money., must be bigger than or equal to 0.');
        }
     ...
     * Sets currency_code
     *
     * @param string $currency_code The ISO currency code for this data.
     *
     * @return self
     */
