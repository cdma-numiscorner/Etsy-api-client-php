...
/**
 * TaxonomyPropertyScale Class Doc Comment
 *
 * @category Class
 ...
 */
class TaxonomyPropertyScale implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxonomyPropertyScale';
     ...
     * Sets scale_id
     *
     * @param int $scale_id The ID of the scale.
     *
     * @return self
     */
    public function setScaleId($scale_id)
    {
        ...
        if (($scale_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $scale_id when calling TaxonomyPropertyScale., must be bigger than or equal to 1.');
        }
     ...
     * Sets display_name
     *
     * @param string $display_name How to label the scale.
     *
     * @return self
     */
