 ...
 */
class TaxonomyPropertyValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxonomyPropertyValue';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['equal_to'] = $data['equal_to'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['equal_to'] === null) {
            $invalidProperties[] = "'equal_to' can't be null";
        }
     ...
     * Sets value_id
     *
     * @param int $value_id The numeric ID of this value.
     *
     * @return self
     */
    public function setValueId($value_id)
    {
        ...
        if (($value_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $value_id when calling TaxonomyPropertyValue., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param string $name How to display the value.
     *
     * @return self
     */
     ...
     * Sets scale_id
     *
     * @param int $scale_id The ID of the scale this belongs to (if any).
     *
     * @return self
     */
    public function setScaleId($scale_id)
    {
        ...
        if (($scale_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $scale_id when calling TaxonomyPropertyValue., must be bigger than or equal to 1.');
        }
     ...
     * Sets equal_to
     *
     * @param int[] $equal_to The list of values this value is equal to (if any).
     *
     * @return self
     */
