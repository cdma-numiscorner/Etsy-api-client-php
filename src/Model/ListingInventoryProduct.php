 ...
 */
class ListingInventoryProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingInventoryProduct';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['property_values'] === null) {
            $invalidProperties[] = "'property_values' can't be null";
        }
     ...
     * Sets product_id
     *
     * @param int $product_id The product to return a ListingProduct for.
     *
     * @return self
     */
    public function setProductId($product_id)
    {
        ...
        if (($product_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $product_id when calling ListingInventoryProduct., must be bigger than or equal to 1.');
        }
