...
/**
 * SellerTaxonomyNodes Class Doc Comment
 *
 * @category Class
 ...
 */
class SellerTaxonomyNodes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SellerTaxonomyNodes';
     ...
     * Sets count
     *
     * @param int $count The number of SellerTaxonomyNode resources found.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling SellerTaxonomyNodes., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param SellerTaxonomyNode[] $results The SellerTaxonomyNode resources found.
     *
     * @return self
     */
