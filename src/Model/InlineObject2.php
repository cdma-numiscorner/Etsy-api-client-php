...
class InlineObject2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'products' => '\EtsyApi\Model\V3ApplicationListingsListingIdInventoryProducts[]',
     ...
     * Gets products
     *
     * @return \EtsyApi\Model\V3ApplicationListingsListingIdInventoryProducts[]
     */
     ...
     * Sets products
     *
     * @param \EtsyApi\Model\V3ApplicationListingsListingIdInventoryProducts[] $products A JSON array of products available in a listing, even if only one product. All field names in the JSON blobs are lowercase.
     *
     * @return self
     */
