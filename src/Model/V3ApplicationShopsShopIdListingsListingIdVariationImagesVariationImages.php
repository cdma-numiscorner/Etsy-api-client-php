...
/**
 * V3ApplicationShopsShopIdListingsListingIdVariationImagesVariationImages Class Doc Comment
 *
 * @category Class
 * @package  EtsyApi
 * @author   OpenAPI Generator team
 ...
 */
class V3ApplicationShopsShopIdListingsListingIdVariationImagesVariationImages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v3_application_shops__shop_id__listings__listing_id__variation_images_variation_images';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['value_id']) && ($this->container['value_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'value_id', must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['image_id']) && ($this->container['image_id'] < 1)) {
    ...
    public function setPropertyId($property_id)
    {
        ...
        if (!is_null($property_id) && ($property_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $property_id when calling V3ApplicationShopsShopIdListingsListingIdVariationImagesVariationImages., must be bigger than or equal to 1.');
        }
     ...
     * Sets value_id
     *
     * @param int|null $value_id value_id
     *
     * @return self
     */
    public function setValueId($value_id)
    {
        ...
        if (!is_null($value_id) && ($value_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $value_id when calling V3ApplicationShopsShopIdListingsListingIdVariationImagesVariationImages., must be bigger than or equal to 1.');
        }
    ...
    public function setImageId($image_id)
    {
        ...
        if (!is_null($image_id) && ($image_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $image_id when calling V3ApplicationShopsShopIdListingsListingIdVariationImagesVariationImages., must be bigger than or equal to 1.');
        }
