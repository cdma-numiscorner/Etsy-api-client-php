...
/**
 * ShippingCarriers Class Doc Comment
 *
 * @category Class
 ...
 */
class ShippingCarriers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingCarriers';
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ShippingCarriers., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param ShippingCarrier[] $results results
     *
     * @return self
     */
