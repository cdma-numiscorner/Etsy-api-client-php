...
/**
 * ListingShippingProfileDestinations Class Doc Comment
 *
 * @category Class
 ...
 */
class ListingShippingProfileDestinations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingShippingProfileDestinations';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'results' => 'ListingShippingProfileDestination[]'
    ];
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ListingShippingProfileDestinations., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param ListingShippingProfileDestination[] $results results
     *
     * @return self
     */
