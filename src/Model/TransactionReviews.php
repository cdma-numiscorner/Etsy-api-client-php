...
/**
 * TransactionReviews Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionReviews implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionReviews';
     ...
     * Sets count
     *
     * @param int $count The number of TransactionReview resources found.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TransactionReviews., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param TransactionReview[] $results The TransactionReview resources found.
     *
     * @return self
     */
