...
/**
 * ShopSections Class Doc Comment
 *
 * @category Class
 ...
 */
class ShopSections implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopSections';
     ...
     * Sets count
     *
     * @param int $count The total number of Shop Sections
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ShopSections., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param ShopSection[] $results The Shop Section resources.
     *
     * @return self
     */
