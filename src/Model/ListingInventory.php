...
/**
 * ListingInventory Class Doc Comment
 *
 * @category Class
 ...
 */
class ListingInventory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingInventory';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['price_on_property'] === null) {
            $invalidProperties[] = "'price_on_property' can't be null";
        }
        if ($this->container['quantity_on_property'] === null) {
            $invalidProperties[] = "'quantity_on_property' can't be null";
        }
        if ($this->container['sku_on_property'] === null) {
            $invalidProperties[] = "'sku_on_property' can't be null";
        }
