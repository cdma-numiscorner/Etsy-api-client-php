...
/**
 * UserAddresses Class Doc Comment
 *
 * @category Class
 ...
 */
class UserAddresses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserAddresses';
     ...
     * Sets count
     *
     * @param int $count The number of UserAddress records being returned.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling UserAddresses., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param UserAddress[] $results An array of UserAddress resources.
     *
     * @return self
     */
