...
class Shops implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets count
     *
     * @param int $count The total number of Shops
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling Shops., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param Shop[] $results The Shop resources.
     *
     * @return self
     */
