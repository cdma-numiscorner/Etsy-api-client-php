...
/**
 * ShopListings Class Doc Comment
 *
 * @category Class
 ...
 */
class ShopListings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopListings';
     ...
     * Sets count
     *
     * @param int $count The number of ShopListing resources found.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ShopListings., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param ShopListing[] $results The ShopListing resources found.
     *
     * @return self
     */
