...
/**
 * ShopListingFiles Class Doc Comment
 *
 * @category Class
 ...
 */
class ShopListingFiles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopListingFiles';
     ...
     * Sets count
     *
     * @param int $count The number of ShopListingFiles being returned..
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ShopListingFiles., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param ShopListingFile[] $results An array of ShopListingFile resources.
     *
     * @return self
     */
