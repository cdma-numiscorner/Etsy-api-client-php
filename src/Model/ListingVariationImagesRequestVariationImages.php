<?php
/**
 * ListingVariationImagesRequestVariationImages
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * ListingVariationImagesRequestVariationImages Class Doc Comment
 *
 * @category Class
 * @package  EtsyApi
 * @author   OpenAPI Generator team
 ...
 */
class ListingVariationImagesRequestVariationImages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingVariationImagesRequest_variation_images';
    ...
    public function setPropertyId($property_id)
    {
        ...
        if (!is_null($property_id) && ($property_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $property_id when calling ListingVariationImagesRequestVariationImages., must be bigger than or equal to 1.');
        }
    ...
    public function setValueId($value_id)
    {
        ...
        if (!is_null($value_id) && ($value_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $value_id when calling ListingVariationImagesRequestVariationImages., must be bigger than or equal to 1.');
        }
    ...
    public function setImageId($image_id)
    {
        ...
        if (!is_null($image_id) && ($image_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $image_id when calling ListingVariationImagesRequestVariationImages., must be bigger than or equal to 1.');
        }
