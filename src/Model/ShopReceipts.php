...
/**
 * ShopReceipts Class Doc Comment
 *
 * @category Class
 ...
 */
class ShopReceipts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopReceipts';
     ...
     * Sets count
     *
     * @param int $count The number of Shop Receipts found.
     *
     * @return self
     */
     ...
     * Sets results
     *
     * @param ShopReceipt[] $results List of Shop Receipt resources found, with all Shop Receipt fields for each resource.
     *
     * @return self
     */
