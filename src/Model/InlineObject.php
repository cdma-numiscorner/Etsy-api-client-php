...
class InlineObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPrice($price)
    {
        ...
        if (($price > 50000)) {
            throw new \InvalidArgumentException('invalid value for $price when calling InlineObject., must be smaller than or equal to 50000.');
        }
        if (($price < 0.2)) {
            throw new \InvalidArgumentException('invalid value for $price when calling InlineObject., must be bigger than or equal to 0.2.');
        }
    ...
    public function setTaxonomyId($taxonomy_id)
    {
        ...
        if (($taxonomy_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $taxonomy_id when calling InlineObject., must be bigger than or equal to 1.');
        }
    ...
    public function setShippingProfileId($shipping_profile_id)
    {
        ...
        if (($shipping_profile_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $shipping_profile_id when calling InlineObject., must be bigger than or equal to 1.');
        }
    ...
    public function setShopSectionId($shop_section_id)
    {
        ...
        if (!is_null($shop_section_id) && ($shop_section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $shop_section_id when calling InlineObject., must be bigger than or equal to 1.');
        }
    ...
    public function setItemWeight($item_weight)
    {
        ...
        if (!is_null($item_weight) && ($item_weight > 1.79769313486E+308)) {
            throw new \InvalidArgumentException('invalid value for $item_weight when calling InlineObject., must be smaller than or equal to 1.79769313486E+308.');
        }
        if (!is_null($item_weight) && ($item_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $item_weight when calling InlineObject., must be bigger than or equal to 0.');
        }
    ...
    public function setItemLength($item_length)
    {
        ...
        if (!is_null($item_length) && ($item_length > 1.79769313486E+308)) {
            throw new \InvalidArgumentException('invalid value for $item_length when calling InlineObject., must be smaller than or equal to 1.79769313486E+308.');
        }
        if (!is_null($item_length) && ($item_length < 0)) {
            throw new \InvalidArgumentException('invalid value for $item_length when calling InlineObject., must be bigger than or equal to 0.');
        }
    ...
    public function setItemWidth($item_width)
    {
        ...
        if (!is_null($item_width) && ($item_width > 1.79769313486E+308)) {
            throw new \InvalidArgumentException('invalid value for $item_width when calling InlineObject., must be smaller than or equal to 1.79769313486E+308.');
        }
        if (!is_null($item_width) && ($item_width < 0)) {
            throw new \InvalidArgumentException('invalid value for $item_width when calling InlineObject., must be bigger than or equal to 0.');
        }
    ...
    public function setItemHeight($item_height)
    {
        ...
        if (!is_null($item_height) && ($item_height > 1.79769313486E+308)) {
            throw new \InvalidArgumentException('invalid value for $item_height when calling InlineObject., must be smaller than or equal to 1.79769313486E+308.');
        }
        if (!is_null($item_height) && ($item_height < 0)) {
            throw new \InvalidArgumentException('invalid value for $item_height when calling InlineObject., must be bigger than or equal to 0.');
        }
