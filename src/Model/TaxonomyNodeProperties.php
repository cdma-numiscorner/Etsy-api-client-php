...
/**
 * TaxonomyNodeProperties Class Doc Comment
 *
 * @category Class
 ...
 */
class TaxonomyNodeProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxonomyNodeProperties';
     ...
     * Sets count
     *
     * @param int $count The number of TaxonomyNodeProperty resources found.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TaxonomyNodeProperties., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param TaxonomyNodeProperty[] $results The TaxonomyNodeProperty resources found.
     *
     * @return self
     */
