 ...
 */
class SellerTaxonomyNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SellerTaxonomyNode';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['full_path_taxonomy_ids'] = $data['full_path_taxonomy_ids'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['full_path_taxonomy_ids'] === null) {
            $invalidProperties[] = "'full_path_taxonomy_ids' can't be null";
        }
     ...
     * Sets id
     *
     * @param int $id The unique ID of this taxonomy node.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling SellerTaxonomyNode., must be bigger than or equal to 1.');
        }
     ...
     * Sets level
     *
     * @param int $level Depth in the taxonomy, roots are at level 0.
     *
     * @return self
     */
    public function setLevel($level)
    {
        ...
        if (($level < 0)) {
            throw new \InvalidArgumentException('invalid value for $level when calling SellerTaxonomyNode., must be bigger than or equal to 0.');
        }
     ...
     * Sets name
     *
     * @param string $name Human readable name for this taxonomy node.
     *
     * @return self
     */
     ...
     * Sets parent_id
     *
     * @param int|null $parent_id ID of our parent node.
     *
     * @return self
     */
    public function setParentId($parent_id)
    {
        ...
        if (!is_null($parent_id) && ($parent_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $parent_id when calling SellerTaxonomyNode., must be bigger than or equal to 1.');
        }
     ...
     * Sets children
     *
     * @param SellerTaxonomyNode[] $children The child Taxonomy nodes, embedded directly in the response.
     *
     * @return self
     */
     ...
     *
     * @param int[] $full_path_taxonomy_ids The taxonomy_ids of this node and all its parents. They are listed in order from root to leaf.
     *
     * @return self
     */
