...
/**
 * ListingShippingProfiles Class Doc Comment
 *
 * @category Class
 ...
 */
class ListingShippingProfiles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingShippingProfiles';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'results' => 'ListingShippingProfile[]'
    ];
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ListingShippingProfiles., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param ListingShippingProfile[] $results results
     *
     * @return self
     */
