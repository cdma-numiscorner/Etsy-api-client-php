...
/**
 * ListingShippingProfileUpgrades Class Doc Comment
 *
 * @category Class
 ...
 */
class ListingShippingProfileUpgrades implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingShippingProfileUpgrades';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'results' => 'ListingShippingProfileUpgrade[]'
    ];
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ListingShippingProfileUpgrades., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param ListingShippingProfileUpgrade[] $results results
     *
     * @return self
     */
