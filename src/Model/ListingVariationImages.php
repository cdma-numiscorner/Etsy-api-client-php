...
/**
 * ListingVariationImages Class Doc Comment
 *
 * @category Class
 ...
 */
class ListingVariationImages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingVariationImages';
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ListingVariationImages., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param ListingVariationImage[] $results results
     *
     * @return self
     */
