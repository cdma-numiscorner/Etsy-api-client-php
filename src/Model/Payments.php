...
class Payments implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets count
     *
     * @param int $count The number of payments in the response.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling Payments., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param Payment[] $results A list of payments.
     *
     * @return self
     */
