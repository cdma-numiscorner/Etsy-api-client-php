...
/**
 * ListingImages Class Doc Comment
 *
 * @category Class
 ...
 */
class ListingImages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingImages';
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ListingImages., must be bigger than or equal to 0.');
        }
