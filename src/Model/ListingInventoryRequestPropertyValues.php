<?php
/**
 * ListingInventoryRequestPropertyValues
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * ListingInventoryRequestPropertyValues Class Doc Comment
 *
 * @category Class
 * @package  EtsyApi
 * @author   OpenAPI Generator team
 ...
 */
class ListingInventoryRequestPropertyValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingInventoryRequest_property_values';
    ...
    public function setPropertyId($property_id)
    {
        ...
        if (!is_null($property_id) && ($property_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $property_id when calling ListingInventoryRequestPropertyValues., must be bigger than or equal to 1.');
        }
    ...
    public function setScaleId($scale_id)
    {
        ...
        if (!is_null($scale_id) && ($scale_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $scale_id when calling ListingInventoryRequestPropertyValues., must be bigger than or equal to 1.');
        }
