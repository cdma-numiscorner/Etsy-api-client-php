 ...
 */
class Pong implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pong';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['application_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'application_id', must be bigger than or equal to 1.";
        }
     ...
     * Sets application_id
     *
     * @param int $application_id The authenticated application's ID
     *
     * @return self
     */
    public function setApplicationId($application_id)
    {
        ...
        if (($application_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $application_id when calling Pong., must be bigger than or equal to 1.');
        }
