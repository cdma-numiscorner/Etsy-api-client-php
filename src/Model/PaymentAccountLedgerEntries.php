...
/**
 * PaymentAccountLedgerEntries Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentAccountLedgerEntries implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentAccountLedgerEntries';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'results' => 'PaymentAccountLedgerEntry[]'
    ];
     ...
     * Sets count
     *
     * @param int $count The number of PaymentAccountLedgerEntry resources found.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling PaymentAccountLedgerEntries., must be bigger than or equal to 0.');
        }
     ...
     * Sets results
     *
     * @param PaymentAccountLedgerEntry[] $results The PaymentAccountLedgerEntry resources found.
     *
     * @return self
     */
