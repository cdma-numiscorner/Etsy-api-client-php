...
class SellerTaxonomyApi
{
     ...
     *
     * @param  int $taxonomy_id The unique ID of an Etsy TaxonomyNode. (required)
     *
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EtsyApi\Model\TaxonomyNodeProperties|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema
     */
     ...
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EtsyApi\Model\TaxonomyNodeProperties|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPropertiesByTaxonomyIdWithHttpInfo($taxonomy_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EtsyApi\Model\TaxonomyNodeProperties' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EtsyApi\Model\TaxonomyNodeProperties', []),
            ...
            $returnType = '\EtsyApi\Model\TaxonomyNodeProperties';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EtsyApi\Model\TaxonomyNodeProperties',
     ...
     */
    public function getPropertiesByTaxonomyIdRequest($taxonomy_id)
    {
        ...
        if ($taxonomy_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$taxonomy_id" when calling SellerTaxonomyApi.getPropertiesByTaxonomyId, must be bigger than or equal to 1.');
        }
     ...
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EtsyApi\Model\SellerTaxonomyNodes|\EtsyApi\Model\ErrorSchema
     */
     ...
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EtsyApi\Model\SellerTaxonomyNodes|\EtsyApi\Model\ErrorSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSellerTaxonomyNodesWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EtsyApi\Model\SellerTaxonomyNodes' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EtsyApi\Model\SellerTaxonomyNodes', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\EtsyApi\Model\SellerTaxonomyNodes';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EtsyApi\Model\SellerTaxonomyNodes',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSellerTaxonomyNodesRequest()
    {
