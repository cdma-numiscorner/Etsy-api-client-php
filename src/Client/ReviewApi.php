...
class ReviewApi
{
     ...
     * @return \EtsyApi\Model\TransactionReviews|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema
     */
    public function getReviewsByShop($shop_id, $limit = 25, $offset = 0)
    {
        list($response) = $this->getReviewsByShopWithHttpInfo($shop_id, $limit, $offset);
        return $response;
    }
     ...
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EtsyApi\Model\TransactionReviews|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReviewsByShopWithHttpInfo($shop_id, $limit = 25, $offset = 0)
    {
        $request = $this->getReviewsByShopRequest($shop_id, $limit, $offset);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EtsyApi\Model\TransactionReviews' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EtsyApi\Model\TransactionReviews', []),
            ...
            $returnType = '\EtsyApi\Model\TransactionReviews';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EtsyApi\Model\TransactionReviews',
     ...
     */
    public function getReviewsByShopAsync($shop_id, $limit = 25, $offset = 0)
    {
        return $this->getReviewsByShopAsyncWithHttpInfo($shop_id, $limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReviewsByShopAsyncWithHttpInfo($shop_id, $limit = 25, $offset = 0)
    {
        $returnType = '\EtsyApi\Model\TransactionReviews';
        $request = $this->getReviewsByShopRequest($shop_id, $limit, $offset);
     ...
     */
    public function getReviewsByShopRequest($shop_id, $limit = 25, $offset = 0)
    {
        ...
        if ($shop_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$shop_id" when calling ReviewApi.getReviewsByShop, must be bigger than or equal to 1.');
        }

        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ReviewApi.getReviewsByShop, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ReviewApi.getReviewsByShop, must be bigger than or equal to 1.');
        }

        if ($offset !== null && $offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling ReviewApi.getReviewsByShop, must be bigger than or equal to 0.');
        }
