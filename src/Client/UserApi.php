...
class UserApi
{
     ...
     * @return \EtsyApi\Model\User|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema
     */
     ...
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EtsyApi\Model\User|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserWithHttpInfo($user_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EtsyApi\Model\User' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EtsyApi\Model\User', []),
    ...
    public function getUserRequest($user_id)
    {
        ...
        if ($user_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$user_id" when calling UserApi.getUser, must be bigger than or equal to 1.');
        }
