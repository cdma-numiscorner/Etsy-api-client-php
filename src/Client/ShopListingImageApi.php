...
class ShopListingImageApi
{
     ...
     * @param  int $listing_image_id The unique numeric image ID of an image in a listing. (required)
     *
     ...
     */
    public function deleteListingImageRequest($shop_id, $listing_id, $listing_image_id)
    {
     ...
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EtsyApi\Model\ListingImage|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema
     */
    public function getListingImage($shop_id, $listing_id, $listing_image_id)
    {
        list($response) = $this->getListingImageWithHttpInfo($shop_id, $listing_id, $listing_image_id);
        return $response;
    }
     ...
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EtsyApi\Model\ListingImage|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListingImageWithHttpInfo($shop_id, $listing_id, $listing_image_id)
    {
        $request = $this->getListingImageRequest($shop_id, $listing_id, $listing_image_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EtsyApi\Model\ListingImage' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EtsyApi\Model\ListingImage', []),
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListingImageAsync($shop_id, $listing_id, $listing_image_id)
    {
        return $this->getListingImageAsyncWithHttpInfo($shop_id, $listing_id, $listing_image_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListingImageAsyncWithHttpInfo($shop_id, $listing_id, $listing_image_id)
    {
        $returnType = '\EtsyApi\Model\ListingImage';
        $request = $this->getListingImageRequest($shop_id, $listing_id, $listing_image_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getListingImageRequest($shop_id, $listing_id, $listing_image_id)
    {
        // verify the required parameter 'shop_id' is set
        if ($shop_id === null || (is_array($shop_id) && count($shop_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $shop_id when calling getListingImage'
            );
        }
        if ($shop_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$shop_id" when calling ShopListingImageApi.getListingImage, must be bigger than or equal to 1.');
        }
     ...
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EtsyApi\Model\ListingImages|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema
     */
    public function getListingImages($shop_id, $listing_id)
    {
        list($response) = $this->getListingImagesWithHttpInfo($shop_id, $listing_id);
        return $response;
    }
     ...
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EtsyApi\Model\ListingImages|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListingImagesWithHttpInfo($shop_id, $listing_id)
    {
        $request = $this->getListingImagesRequest($shop_id, $listing_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EtsyApi\Model\ListingImages' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EtsyApi\Model\ListingImages', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\EtsyApi\Model\ListingImages';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListingImagesAsync($shop_id, $listing_id)
    {
        return $this->getListingImagesAsyncWithHttpInfo($shop_id, $listing_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListingImagesAsyncWithHttpInfo($shop_id, $listing_id)
    {
        $returnType = '\EtsyApi\Model\ListingImages';
        $request = $this->getListingImagesRequest($shop_id, $listing_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getListingImagesRequest($shop_id, $listing_id)
    {
        // verify the required parameter 'shop_id' is set
        if ($shop_id === null || (is_array($shop_id) && count($shop_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $shop_id when calling getListingImages'
            );
        }
        if ($shop_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$shop_id" when calling ShopListingImageApi.getListingImages, must be bigger than or equal to 1.');
        }
