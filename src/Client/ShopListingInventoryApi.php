...
/**
 * ShopListingInventoryApi Class Doc Comment
 *
 * @category Class
 * @package  EtsyApi
 * @author   OpenAPI Generator team
...
class ShopListingInventoryApi
{
     ...
     * @return \EtsyApi\Model\ListingInventory|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema
     */
    public function getListingInventory($listing_id)
    {
        list($response) = $this->getListingInventoryWithHttpInfo($listing_id);
        return $response;
    }

    /**
     * Operation getListingInventoryWithHttpInfo
     *
     * @param  int $listing_id The unique numeric ID for a listing in a specific [shop](/documentation/reference#tag/Shop). (required)
     *
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EtsyApi\Model\ListingInventory|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema|\EtsyApi\Model\ErrorSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListingInventoryWithHttpInfo($listing_id)
    {
        $request = $this->getListingInventoryRequest($listing_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EtsyApi\Model\ListingInventory' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EtsyApi\Model\ListingInventory', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EtsyApi\Model\ListingInventory',
    ...
    /**
     * Operation getListingInventoryAsync
     *
     * 
     *
     * @param  int $listing_id The unique numeric ID for a listing in a specific [shop](/documentation/reference#tag/Shop). (required)
     ...
     */
    public function getListingInventoryAsync($listing_id)
    {
        return $this->getListingInventoryAsyncWithHttpInfo($listing_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getListingInventoryAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $listing_id The unique numeric ID for a listing in a specific [shop](/documentation/reference#tag/Shop). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListingInventoryAsyncWithHttpInfo($listing_id)
    {
        $returnType = '\EtsyApi\Model\ListingInventory';
        $request = $this->getListingInventoryRequest($listing_id);
    ...
    /**
     * Create request for operation 'getListingInventory'
     *
     * @param  int $listing_id The unique numeric ID for a listing in a specific [shop](/documentation/reference#tag/Shop). (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getListingInventoryRequest($listing_id)
    {
        // verify the required parameter 'listing_id' is set
        if ($listing_id === null || (is_array($listing_id) && count($listing_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $listing_id when calling getListingInventory'
            );
        }
        if ($listing_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$listing_id" when calling ShopListingInventoryApi.getListingInventory, must be bigger than or equal to 1.');
        }


        $resourcePath = '/v3/application/listings/{listing_id}/inventory';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $listing_id The unique numeric ID for a listing in a specific [shop](/documentation/reference#tag/Shop). (required)
     * @param  \EtsyApi\Model\InlineObject3 $inline_object3 inline_object3 (optional)
     *
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function updateListingInventory($listing_id, $inline_object3 = null)
    {
        list($response) = $this->updateListingInventoryWithHttpInfo($listing_id, $inline_object3);
        return $response;
    }
     ...
     *
     * @param  int $listing_id The unique numeric ID for a listing in a specific [shop](/documentation/reference#tag/Shop). (required)
     * @param  \EtsyApi\Model\InlineObject3 $inline_object3 (optional)
     *
     * @throws \EtsyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function updateListingInventoryWithHttpInfo($listing_id, $inline_object3 = null)
    {
        $request = $this->updateListingInventoryRequest($listing_id, $inline_object3);
    ...
    /**
     * Operation updateListingInventoryAsync
     *
     * 
     *
     * @param  int $listing_id The unique numeric ID for a listing in a specific [shop](/documentation/reference#tag/Shop). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateListingInventoryAsync($listing_id, $inline_object3 = null)
    {
        return $this->updateListingInventoryAsyncWithHttpInfo($listing_id, $inline_object3)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateListingInventoryAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $listing_id The unique numeric ID for a listing in a specific [shop](/documentation/reference#tag/Shop). (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateListingInventoryAsyncWithHttpInfo($listing_id, $inline_object3 = null)
    {
        $returnType = '\EtsyApi\Model\ListingInventory';
        $request = $this->updateListingInventoryRequest($listing_id, $inline_object3);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateListingInventoryRequest($listing_id, $inline_object3 = null)
    {
        // verify the required parameter 'listing_id' is set
        if ($listing_id === null || (is_array($listing_id) && count($listing_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $listing_id when calling updateListingInventory'
            );
        }
        if ($listing_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$listing_id" when calling ShopListingInventoryApi.updateListingInventory, must be bigger than or equal to 1.');
        }
